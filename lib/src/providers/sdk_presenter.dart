...
import '/src/providers/http_service.dart';
import '/src/utilities/sdk_constant.dart';
import '../../sdk.dart';
...
class SdkPresenter {
  ...
  Future<Response?> getOrder(
      authToken, merchantId, billdeskOrderId, config) async {
  ...
  Future<Response?> getMandateOrder(
      authToken, mercid, mandateTokenId, config) async {
    Map<String, String> headers = {
      'Authorization': authToken,
      'Content-Type': 'application/json',
      'Accept': 'application/json',
  ...
  Future<Response?> queryWeb(
      authToken, mercid, bdorderid, orderId, config) async {
    Map<String, String> headers = {
      'Authorization': authToken,
      'Content-Type': 'application/json',
      'Accept': 'application/json',
  ...
  Future<Response?> polling(authToken, mercid, mandateTokenId, config) async {
    Map<String, String> headers = {
      'Authorization': authToken,
      'Content-Type': 'application/json',
      'Accept': 'application/json',
